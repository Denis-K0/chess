...
export const showPiecesMovements =  {
    pawn(enemyColor, piecePosition, board, pieceColor) {
        let possibleMoves = [];
        possibleMoves.push(getPawnMoves(enemyColor, piecePosition, board, pieceColor));
        return possibleMoves;
    },
    tower(enemyColor, piecePosition, board, pieceColor, pieceId, check) {
        let possibleMoves = [];
        possibleMoves.push(getTowerMoves(enemyColor, piecePosition, board, pieceColor));
        possibleMoves.push(getRochadMoves(enemyColor, piecePosition, board, pieceColor, pieceId, check));
        return possibleMoves;
    },
    knight(enemyColor, piecePosition, board, pieceColor) {
        let possibleMoves = [];
        possibleMoves.push(getKnightMoves(enemyColor, piecePosition, board, pieceColor));
        return possibleMoves;
    },
    bishop(enemyColor, piecePosition, board, pieceColor) {
        let possibleMoves = [];
        possibleMoves.push(getBishopMoves(enemyColor, piecePosition, board, pieceColor));
        return possibleMoves;
    },
    ...
    king(enemyColor, piecePosition, board, pieceColor) {
        let possibleMoves = [];
        possibleMoves.push(getKingMoves(enemyColor, piecePosition, board, pieceColor));
        return possibleMoves;
    },

};

// The move skills of the Pieces:

function getPawnMoves(enemyColor, piecePosition, board, pieceColor) {
    ...
    function getMoves() {
        // Single-Step
        if (row + direction < 0 || row + direction > 7 || col < 0 || col > 7) return;
...
function getTowerMoves(enemyColor, piecePosition, board, pieceColor) {
    const [row, col] = piecePosition;
    let movePoints = [];
...
function getRochadMoves(enemyColor, piecePosition, board, pieceColor, pieceId, check) {
    ...
    if (checkTowerConditions() || checkKingConditions() || check) return;
...
function getKnightMoves(enemyColor, piecePosition, board, pieceColor) {
    const [row, col] = piecePosition;
    let movePoints = [];
...
function getBishopMoves(enemyColor, piecePosition, board, pieceColor) {
    const [row, col] = piecePosition;
    let movePoints = [];
...
function getKingMoves(enemyColor, piecePosition, board, pieceColor) {
    const [row, col] = piecePosition;
    let movePoints = [];
